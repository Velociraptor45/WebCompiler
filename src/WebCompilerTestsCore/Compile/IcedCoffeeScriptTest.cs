...
namespace WebCompilerTest
{
    ...
    public class IcedCoffeeScriptTest
    {
        ...
        public void Cleanup()
        {
            File.Delete("../../../../WebCompilerTest/artifacts/iced/test.js");
            File.Delete("../../../../WebCompilerTest/artifacts/iced/test.min.js");
            File.Delete("../../../../WebCompilerTest/artifacts/iced/test.js.map");
        }

        [TestMethod, TestCategory("Iced CoffeeScript")]
        public void CompileIcedCoffeeScript()
        {
            var result = _processor.Process("../../../../WebCompilerTest/artifacts/icedcoffeeconfig.json");
            FileInfo js = new FileInfo("../../../../WebCompilerTest/artifacts/iced/test.js");
            FileInfo map = new FileInfo("../../../../WebCompilerTest/artifacts/iced/test.js.map");
